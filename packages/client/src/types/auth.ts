...
export type AuthURIGen = Pick<
	AuthParameters,
	'authorizationUri' | 'codeVerifier' | 'codeChallenge'
>;

export type POST = Partial<
	Pick<
		AuthParameters,
		'clientId' | 'redirectUri' | 'grantType' | 'code' | 'codeVerifier'
	> &
...
export type Tokens = Record<string, string | null>;
